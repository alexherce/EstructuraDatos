...
namespace ahb {
    ...
    public:
        ...
        bool brothers(BNode<T> * node, BNode<T>* node2);
        void cousins(BNode<T> * node);
    ...
    template <class T>
    bool BinaryTree<T>::brothers(BNode<T> * nodo, BNode<T> * nodo2)
    {
        
        if (nodo->getParent() == nodo2->getParent())
        {
            return true;
        }
    ...
    template <class T>
    void BinaryTree<T>::cousins(BNode<T> * nodo)
    {
        BNode<T> * node = nodo->getParent()->getParent();
